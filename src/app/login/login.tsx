...
export default function Login() {
  ...
  const handleAppleLogin = async () => {
    ...
    if (error) alert("애플 로그인 실패: " + error.message);
  };
    ...
    <main className="bg-[#ffffff] flex flex-col items-start md:items-center justify-between min-h-[844px] overflow-hidden">
      <div className="flex flex-col gap-0 items-start md:items-center justify-start self-stretch">
        ...
        <div className="pt-1 pr-4 pb-3 pl-4 flex flex-row gap-2 items-center justify-between w-full max-w-[480px]">
          <Link href="/forgot-password" className="text-[#a1824a] text-left font-['PlusJakartaSans-Regular'] text-sm leading-[21px] font-normal">
            비밀번호를 잊으셨나요?
          </Link>
          <Link href="/signup" className="text-[#a1824a] text-right font-['PlusJakartaSans-Bold'] text-sm leading-[21px] font-bold">
            회원가입
          </Link>
        </div>
          ...
          <div className="pt-3 pr-4 pb-3 pl-4 flex flex-row gap-0 items-start md:items-center justify-start md:justify-center flex-wrap w-full max-w-[480px]">
            ...
            >
              <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M15.4091 5.21967C15.8821 4.63866 16.2048 3.82384 16.1115 3C15.4195 3.02604 14.5768 3.44217 14.083 4.00734C13.6413 4.50901 13.2563 5.34467 13.3703 6.14384C14.1488 6.21125 14.9153 5.79512 15.4091 5.21967Z" fill="white"/>
              </svg>
